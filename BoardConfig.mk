...
TARGET_BOARD_INFO_FILE := device/samsung/superiorcmcc/board-info.txt
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/samsung/superiorcmcc/bluetooth
BOARD_BLUEDROID_VENDOR_CONF := device/samsung/superiorcmcc/bluetooth/vnd_superior.txt
...
# Selinux
BOARD_SEPOLICY_DIRS += \
    device/samsung/superiorcmcc/selinux
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/samsung/superiorcmcc/recovery/recovery_keys.c
BOARD_UMS_LUNFILE := "/sys/class/android_usb/f_mass_storage/lun0/file"
BOARD_USES_MMCUTILS := true
BOARD_HAS_NO_MISC_PARTITION := true
BOARD_HAS_NO_SELECT_BUTTON := true
TARGET_RECOVERY_FSTAB := device/samsung/superiorcmcc/rootdir/fstab.superior
RECOVERY_FSTAB_VERSION := 2

# assert
TARGET_OTA_ASSERT_DEVICE := superior,superiorcmcc,GT-I9268

# Use the non-open-source parts, if they're present
-include vendor/samsung/superiorcmcc/BoardConfigVendor.mk
