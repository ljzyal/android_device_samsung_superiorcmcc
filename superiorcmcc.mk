...
LOCAL_PATH := device/samsung/superiorcmcc
...
PRODUCT_COPY_FILES += \
    device/samsung/superiorcmcc/configs/nfcee_access.xml:system/etc/nfcee_access.xml
...
$(call inherit-product-if-exists, vendor/samsung/superiorcmcc/superiorcmcc-vendor.mk)
